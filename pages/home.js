...
<section className='bg-gradient-to-r from-fuchsia-200 to-fuchsia-300'> 
...
<section>
  ...
  src="./assest/face5.jpg" alt="Face"/>
	  <h4 class="mb-3 text-2xl font-semibold text-center tracking-tight text-sky-900">علاجات الوجه</h4>
  </div>
  </div>
  </section>
  <section>
