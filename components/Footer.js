...
const Footer = () => {
    return (
        <>
            <section class='bg-white text-gray-700' id='profilefoot'>
                <div>
                        ...
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <div class="flex items-center gap-x-8 mt-4">
                                ...
                                <a className="pb-0.5 rounded-full hover:scale-125" href="https://www.facebook.com/profile.php?id=100010107875359"
                                    ...
                                    data-tippy-content="Facebook"><svg width="21" height="21" class="fill-current text-blue-600" role="img"
                            ...
                            <p class="font-mono text-xs hover:scale-105">Inc. All Rights Reserved</p>                                
                                <div class="border-l border-gray-800 sm:pl-2 sm:ml-2">
                                    <a href='https://wa.me/+962788818125' class="sm:block hidden font-mono text-xs hover:scale-105">2022 <span class="text-xs font-mono">MHMAD
                                    WREKAT</span></a>
                                </div>
                            </div>
                            <a href='https://wa.me/+962788818125' class="block sm:hidden pt-2 font-mono text-xs hover:scale-105">2022 <span class="text-xs font-mono">MHMAD
                                    WREKAT</span></a>
                        </div>
                    </div>
                </div>
